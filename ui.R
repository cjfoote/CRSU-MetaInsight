...
shinyUI(navbarPage(id="meta",
  ...
  tabPanel(id="home", "Home", 
     ...
     br(),
       ...
       p("Codes for this app are available on Github. Please click ", tags$a(href="https://github.com/yiqiaoxin/CRSU-MetaInsight", "here",target="_blank"), "to access."),
       br(),
       ...
       tabsetPanel(
         tabPanel("1. Data summary", tabsetPanel(
           tabPanel("1a. Data Characteristics", 
            ...
            tabPanel("1b. Study Results", plotOutput("forestPlot", height = "1000px", width = "800px"), radioButtons('format_freq0', 'Document format', c('PDF', 'SVG'), inline = TRUE),  downloadButton('downloadStudy')),
