...
shinyServer(function(input, output, session) {
  ...
  freq_all= function(){
      ...
      freq_wrap(data_wide, treat_list,input$modelranfix,outc,input$metaoutcome)  # use the selfdefined function, freq_wrap
  ...
  freq_sub= function(){
    ...
    outc <- ifelse (input$metaoutcome=="Continuous",input$outcomeCont, input$outcomebina)
    freq_wrap(data_sub, treat_list,input$modelranfix,outc, input$metaoutcome)
  }
  


  
  ### 1a. Study results forest plot
  ...
  make_netgraph = function(freq) {    # network plot
  ...
  model <- eventReactive(input$baye_do, {
      ...
      outc <- ifelse (input$metaoutcome=="Continuous",input$outcomeCont, input$outcomebina)
      baye(longsort2,treat_list,input$modelranfix, outc,input$metaoutcome )
    })
  ...
  model_sub <- eventReactive(input$sub_do, {
      ...
      outc <- ifelse (input$metaoutcome=="Continuous",input$outcomeCont, input$outcomebina)
      baye(long_sort2_sub,treat_list,input$modelranfix, outc,input$metaoutcome)
    })
